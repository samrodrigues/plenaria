  ...
  <div class="mt-3">
    ...
    <div class="mt-1 flex gap-1">
      <div class="flex-grow-1">
        ...
        <div class="mt-1">
          <input type="number" v-model="dob.day" min="1" max="31" name="day" id="day" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="DD" />
        </div>
      </div>
      <div class="flex-grow-1">
        <div>
          <label for="month" class="block text-sm font-medium text-gray-700">Location</label>
          <select v-model="dob.month" id="month" name="location" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
      ...
      <div class="year-container">
        ...
        <div class="mt-1">
          <input v-model="dob.year" min="1900" max="2100" type="number" name="year" id="year" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="AAAA" />
        </div>
      </div>
    </div>
    <div class="mt-5">
      <button @click="validateMember" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Avançar &gt;</button>
    </div>
  </div>
</template>
